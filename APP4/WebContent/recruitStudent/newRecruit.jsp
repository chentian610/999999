...
<div class="zjq-apply-page">
    ...
    <div class="zjq-tablePage">
        ...
        <div class="zjq-publish">
            <input class="btn btn-default zjq-publishBtn" type="button" value="发布" id="release">
        </div>
    </div>
    <div class="zjq-select-modal">
        <div class="zjq-makeSurePage">
            ...
            <div class="zjq-publish">
                <input class="btn btn-default zjq-publishBtn" type="button" value="确认发布" id="checkRelease">
            </div>
        </div>
    </div>
</div>
