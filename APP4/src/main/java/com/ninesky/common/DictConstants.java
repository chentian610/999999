...
public class DictConstants {
	 ...
	 * 数据字典：app定向更新
	 */
	public static final Integer DIRECTIONAL_UPDATE = -1;
	 ...
	 * 学校状态：删除申请
	 */
	public static final String SCH_STATUS_DELETE = "007020";

	/**
	 * 学校状态：app上线
	 */
	public static final String SCH_STATUS_GO_ONLINE = "007025";

	/**
	 * 学校状态：app上线
	 */
	public static final String SCH_STATUS_OFFLINE = "007030";
	 ...
	 * 模块类型：学生请假
	 */
	public static final String MODULE_CODE_STUDENT_LEAVE="009008";
	 ...
	 * 选课模块
	 */
	public static final String MODULE_CODE_CURRICULA_VARIABLE="009016";
	 ...
	 * 模块类型：班级评分
	 */
	public static final String MODULE_CODE_CLASS_SCORE="009022";

	/**
	 * 模块类型：个人评分
	 */
	public static final String MODULE_CODE_PERSON_SCORE="009028";
	 ...
	 * 模块类型：学校缴费
	 */
	public static final String MODULE_CODE_SCHOOL_PAY="009029";
	/**
	 * 模块类型：便民缴费
	 */
	public static final String MODULE_CODE_CONVENIENCE_PAY="009030";

  /**
  *一周菜谱
  */
	public static final String MODULE_CODE_SCHOOL_MENU="009033";
	
	/**
	 * 模块类型：学生通勤
	 */
	public static final String MODULE_CODE_STUDENT_ATTEND="009035";
	...
	/**
	 * 考勤结果状态：已到，学生请假与考勤联通所需要
	 */
	public static final String ATTEND_STATUS_ARRIVE="013044";
	 ...
	 * 请假申请
	 */
	public static final String LEAVE_STATUS_CLASS = "034035";
	 ...
	 * 抄送请假申请
	 */
	public static final String LEAVE_STATUS_CC = "034035";
	 ...
	 * 选课模块：报名成功
	 */
	public static final String APPLY_SUCCESS="040005";
	/**
	 * 选课模块：等待筛选
	 */
	public static final String APPLY_WAIT_SCREEN="040010";
	/**
	 * 选课模块：报名失败
	 */
	public static final String APPLY_FAIL="040015";
	/**
	 * 选课模块：已退出班级
	 */
	public static final String APPLY_OUT_CLASS="040020";
	/**
	 * 选课模块：未报名
	 */
	public static final String UN_APPLY="040025";
	/**
	 * 支付宝支付状态
	 */
	 ...
	 * 支付类型 039
	 */
	public static final String PAYMENT_TYPE= "039";
	/**
	 * 支付宝 039001
	 */
	public static final String PAYMENT_TYPE_ALIPAY= "039001";
	/**
	 * 缴费:学校收费
	 */
	public static final String PAY_TYPE_SCHOOL_CHARGE = "038001";
	/**
	 * 缴费:便民收费
	 */
	public static final String PAY_TYPE_CONVENIENCE_CHARGE = "038002";

	/**
	 * 招生报名状态：未录取
	 */
	public static final String ENROLL_STATUS_NEW="043001";
	/**
	 * 招生报名状态:已录取
	 */
	public static final String ENROLL_STATUS_PASS="043002";

	/**
	 * 教师通勤状态：正常
	 */
	public static final String TEACHER_ATTEND_NORMAL="046001";

	/**
	 * 教师通勤状态：迟到
	 */
	public static final String TEACHER_ATTEND_LATE="046002";

	/**
	 * 教师通勤状态：早退
	 */
	public static final String TEACHER_ATTEND_LEAVE_EARLY="046003";

	/**
	 * 教师通勤状态：缺勤
	 */
	public static final String TEACHER_ATTEND_ABSENCE="046004";

	/**
	 * 教师通勤类型：上班
	 */
	public static final String TEACHER_ATTEND_TYPE_GOWORK="047001";

	/**
	 * 教师通勤类型：下班
	 */
	public static final String TEACHER_ATTEND_TYPE_OFFWORK="047002";
}
