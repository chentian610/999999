(function($, window, document) {
	...
	$.PullToRefresh = $.Class.extend({
		...
		endPullUpToRefresh: function(finished,none) {
			if (finished) {
				this.finished = true;
				this.pullUpTipsIcon.innerHTML = this.options.up.contentnomore;
				if (none) {
					this.pullUpTipsIcon.innerHTML = this.options.up.contentnone;
				}
	...
	$.fn.pullToRefresh = function(optionsArr) {
		var pullRefreshApis = [];
		optionsArr = optionsArr || {};
		this.each(function(i) {
			var self = this;
			var pullRefreshApi = null;
			var options = optionsArr[i] || optionsArr;
