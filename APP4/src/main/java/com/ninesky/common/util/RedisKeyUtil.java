...
public class RedisKeyUtil {
	 ...
	 * 存放动态时间redis Key前缀
	 */
	public static final String KEY_INFO_PRE="INFO:";
	...
	public static String getNewsDictGroupKey(Integer school_id,String dict_group) {
		StringBuffer sb = new StringBuffer("NEWS_GROUP:SCHOOL_ID"+school_id).append(":NEWS_GROUP"+dict_group);
		return sb.toString();
	}
	 ...
	 * @return 唯一Key
	 */
	public static String getSingleDynamicKey(String module_code,Integer module_pdid,Integer user_id,String suffix){
		return KEY_DYNAMIC_PRE+KEY_MODULE_CODE+module_code+KEY_MODULE_PKID+module_pdid+":"+user_id+":"+suffix;
	}
	...
	public static String getHomeworkKey(Integer school_id,Integer homework_id,Integer student_id){
		if (IntegerUtil.isEmpty(student_id)) return "HOMEWORK_ITEM:SCHOOL_ID"+school_id+":HOMEWORK_ID:"+homework_id+"";
		else return "HOMEWORK_STUDENT:SCHOOL_ID"+school_id+":HOMEWORK_ID"+homework_id+":STUDENT_ID"+student_id+"";
	}
	...
	public static String getDictSchoolByKey(Integer school_id,String dict_code){
		return "SYSTEM_DICT:SCHOOL_ID"+school_id+":DICT_CODE"+dict_code+"";
	}
	 ...
	 * @return
	 */
	public static String getInterstKey(Integer school_id,Integer id){
		return "INTERST:SCHOOL_ID"+school_id+":ID"+id+"";
	}
	 ...
	 * @return
	 */
	public static String getBalanceOfAgentKey(Integer agent_id) {return "INTERST:AGENT_ID"+agent_id;}
	 ...
	 * @return
	 */
	public static String getSchoolNameKey(Integer school_id){return "SCHOOL_NAME:SCHOOL_ID"+school_id+"";}

	/**
	 * 获取支付订单相关的业务数据KEY，如果存在说明该订单正在处理中，避免重复提交支付
	 * @param module_code
	 * @param pay_id
	 * @return
	 */
    public static String getPayUnionKey(String module_code, Integer pay_id) {
		return "TRADE_INFO:"+getUnionKey()+module_code+":"+pay_id;
    }
	 ...
	 * @return
	 */
	public static String getPayTeamNamesKey(Integer school_id,String user_type, Integer pay_id) {
		return "PAY:TEAM_NAMES:SCHOOL_ID"+school_id+":USER_TYPE"+user_type+":PAY_ID"+pay_id+"";
	}
	 ...
	 * @return
	 */
	public static String getSchoolTeacherRoleCodesKey(Integer school_id,String user_type,String phone){
		return "USER_INFO:UNION_KEY:SCHOOL_ID"+school_id+":USER_TYPE"+user_type+":PHONE"+phone;
	}

	public static String getNoticeRemindKey(String module_code,Integer notice_id,Integer school_id){
		return "NOTICE_REMIND:"+"SCHOOL_ID"+school_id+":MODULE_CODE"+module_code+KEY_NOTICE_ID+notice_id;
	}
}
