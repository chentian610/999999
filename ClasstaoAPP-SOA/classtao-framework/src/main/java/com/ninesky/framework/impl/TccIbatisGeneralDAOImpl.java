...
import com.ninesky.framework.TccGeneralDAO;
...
public class TccIbatisGeneralDAOImpl implements TccGeneralDAO {

	private static Logger _logger = LoggerFactory.getLogger(TccIbatisGeneralDAOImpl.class);

	private SqlSessionTemplate sqlSession;
	

	public TccIbatisGeneralDAOImpl(SqlSessionTemplate sqlMapClient) {
		this.sqlSession = sqlMapClient;
		_logger.debug("Mybatis数据库连接对象注入TccGeneralDAO完成");
	}
