...
<head>
    ...
    <style type="text/css">
        ...
        *{margin: 0;padding: 0;}
        ...
        .zjq-applyDetail dd{height: 46px;line-height: 46px;margin: 14px 0;position: relative;font-size: 16px;color: #4A4A4A;}
        .zjq-applyDetail dd span{font-size: 16px;color: #4A4A4A;margin-right: 25px;width: 50px;display: inline-block;}
        ...
        .zjq-circleIcon:before{content: "";background: #D8D8D8;margin-left:50%;height:100%;display: block;border-radius:0 100% 100% 0/50%;transform-origin:0 50%;transform:rotate(156deg);}
        ...
        .zjq-select-modal{background: rgba(91,91,91,.4);position: absolute; top:0px; left: 0px;right: 0;bottom: 0;min-height: 140%;display: none;z-index: 1133;}
