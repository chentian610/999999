...
import com.ninesky.common.vo.ResultVO;
...
public class ResponseUtils {
	...
	public static Map<String,Object> sendFailure(ErrorCode error_code) {
		return sendFailure(error_code.getError_desc(),error_code.getError_code());
	}
	
	public static Map<String, Object> sendFailure(String message, Integer errcode) {
		Map<String, Object> map = getInstanceMap();
		map.put(RESPONSE_SUCCESS_KEY, false);
		map.put(RESPONSE_CODE, errcode==null?0:errcode);
