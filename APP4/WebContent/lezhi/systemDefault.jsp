...
<body>
	<!--Navigation-->
	<nav>
		<input id="user_type" type="text" value="003099" hidden="hidden" />
	...
	<div class="wrap">
		<div class="user-top">
			<div class="pull-right">
				'
				<div class="user-name">
					<img src="" alt="" id="headUrl"><span id="userName">(系统管理员）</span>
				</div>
				<div class="user-do">
			...
			<div class="page-nav-cont J_menuTabs">
				<div class="page-tabs-content">
					<a href="javascript:;" class="active J_menuTab"
						data-id="lezhi/print.jsp">申请管理 <i class="fa fa-times-circle"></i>
					</a>
				</div>
			</div>
		</div>
		<div class="J_mainContent" id="content-main">
			<iframe class="J_iframe" name="iframe1" width="100%" height="100%"
				src="application/applicationManager.jsp" frameborder="0"
				data-id="application/applicationManager.jsp" seamless=""></iframe>
		</div>
	</div>
