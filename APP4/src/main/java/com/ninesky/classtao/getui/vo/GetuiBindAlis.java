package com.ninesky.classtao.getui.vo;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.gexin.rp.sdk.http.IGtPush;
import com.ninesky.classtao.getui.GetuiConfig;

public class GetuiBindAlis implements Runnable {
	private static Logger logger = LoggerFactory.getLogger(GetuiBindAlis.class);
