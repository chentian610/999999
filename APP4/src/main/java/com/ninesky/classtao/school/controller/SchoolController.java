...
public class SchoolController extends BaseController{
	 ...
	 * @return
	 */
	@RequestMapping(value="/updateSchoolSetInfo")
	public Object updateSchoolSetInfo(HttpServletRequest request){
		SchoolVO vo = BeanUtil.formatToBean(SchoolVO.class);
		schoolService.updateSchoolSetInfo(vo);
		return ResponseUtils.sendSuccess();
	}
	...
	public Object addLocationInfo(){
		SchoolVO vo=BeanUtil.formatToBean(SchoolVO.class);
		schoolService.addLocationInfo(vo);
		return ResponseUtils.sendSuccess();
	}
}
